...
function EditCouponDiscount({ user, handleClose, open }) {
  ...
  const makeAPICall = async (data) => {
    ...
    try {
      const response = await axios.post(
        "https://medical.studiomyraa.com/api/update_providers_coupons",
        data,
        {
          headers: {
  ...
  const handleAPICall = () => {
    ...
    formData.append("id", user.id ? user.id :'Oop! No..id');
  ...
  return (
      ...
      <Dialog
          ...
          onClose={handleClose}
        >
            <DialogTitle>Edit Coupon & Discount</DialogTitle>
      <CardContent>
