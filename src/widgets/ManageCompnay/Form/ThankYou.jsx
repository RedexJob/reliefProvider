...
function ThankYou() {
  ...
  const handleClickOpen = () => {
    ...
    useEffect(() => {
        ...
        axios
          .get("https://medical.studiomyraa.com/api/get_providers_emailtemplate/1", {
    ...
    <>
      <Widget name="PatientsList">
        <WidgetBody style={{ padding: 0 }}>
          <Typography variant="h6" style={{marginLeft:'15px'}} >Email Templates</Typography>
          ...
          <Dialog
            ...
            onClose={handleClose}
          >
            <DialogTitle>ADD Email Content</DialogTitle>
            <CreateThankYou handleClose={handleClose} />
            {/* <DialogActions>
