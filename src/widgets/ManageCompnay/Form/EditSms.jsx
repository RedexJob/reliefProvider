...
function EditSms({ user, handleClose, open }) {
    ...
    const makeAPICall = async (data) => {
      ...
      try {
        const response = await axios.post(
          "https://medical.studiomyraa.com/api/update_providers_smstemplate",
          data,
          {
            headers: {
  ...
  return (
       ...
       <Dialog
        ...
        >
      <CardContent>
        <Typography variant="h5">Edit SMS Template</Typography>
