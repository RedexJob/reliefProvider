...
const Reportset = lazy(() => import('@pages/Reportset'));
const Productview = lazy(() => import('@pages/Productsadd'));
const Findorder = lazy(() => import('@pages/Product'));
            ...
            <div className="app_content">
                ...
                <Suspense fallback={<WidgetsLoader />}>
                    <Routes>
                        ...
                        <Route path="/find_patient" element={<Tests/>}/>
                        <Route path="/get" element={<Doctors/>}/>
                        <Route path="/view" element={<StaffList/>}/>
                        
                        {/* <Route path="/login" element={<Login/>}/> */}
                        <Route path="/manage_company" element={<Managecompany/>}/>
                        <Route path="/my_account" element={<Myaccount/>}/>
                        <Route path="/report" element={<Reportset/>}/>
                        <Route path="/view_product" element={<Findorder/>}/>
                        <Route path="/add_product" element={<Productview/>}/>
